...
public:
	...
	const Primitive*	prim;	// Primitive intersected, NULL if a light was intersected
	const Light*		light;	// Light intersected, NULL if a primitive was intersected
	const Material*		mat;	// Material of the primitive, if a primitive was intersected
